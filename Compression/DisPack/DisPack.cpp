...
static inline sU8 Load8(sU8 *s)             { return *s; }
static inline sU16 Load16(sU8 *s)           { return value16(s); }
static inline sU16 Load16B(sU8 *s)          { return value16b(s); }
static inline sU32 Load32(sU8 *s)           { return value32(s); }
static inline sU32 Load32B(sU8 *s)          { return value32b(s); }

static inline void Store8(sU8 *d,sU8 v)     { *d = v; }
static inline void Store16(sU8 *d,sU16 v)   { setvalue16(d,v); }
static inline void Store16B(sU8 *d,sU16 v)  { setvalue16b(d,v); }
static inline void Store32(sU8 *d,sU32 v)   { setvalue32(d,v); }
static inline void Store32B(sU8 *d,sU32 v)  { setvalue32b(d,v); }
...
struct DisFilterCtx
{
  ...
  sU8 *Flush(sU32 &size)
  {
    ...
    // alloc output buffer
    sU8 *out = (sU8*) malloc (sizeof(sU8) * size);
